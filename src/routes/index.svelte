    ...
    <div class="mainbox">
        ...
        {#if dataJSON}
            {#if dataline}
                ...
                {#if dataJSON.results}
                    <details>
                        <summary>Raw acceleration data ({dataJSON.results.length} results in total) </summary>
                ...
                {#if tempJSON.results}
                    <details>
                        <summary>Raw temperature data ({tempJSON.results.length} results in total) </summary>
